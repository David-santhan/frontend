                            ...
                            <Offcanvas.Body>
                                ...
                                <Nav>
                                    <Navbar.Brand href="/Profile">
                                        <Img src={localStoreProfile ? `https://hrbackend-2.onrender.com/${localStoreProfile}` : '/Images/defaultProfilePic.png'} style={{ width: "70px", borderRadius: "50px", margin: '10px' }} />
                                    </Navbar.Brand>

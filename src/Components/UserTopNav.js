                            ...
                            <Offcanvas.Body>
                                ...
                                <Nav>
                                    <Navbar.Brand href="/Profile">
                                        <Img src={localStoreProfile ? `https://ornnovabackend.onrender.com/${localStoreProfile}` : '/Images/defaultProfilePic.png'} style={{ width: "70px", borderRadius: "50px", margin: '10px' }} />
                                    </Navbar.Brand>

...
function UpdateUser() {
    ...
    useEffect(() => {
        axios.get(`https://hrbackend-2.onrender.com/getUserdatatoUpdate/${id}`)
            .then(res => {
                setUserValue({
                    ...userValue,
    ...
    const handleSubmit = async (e) => {
      ...
      try {
          const response = await axios.put(`https://hrbackend-2.onrender.com/updateUser/${id}`, updatedUserData);
    ...
    const gettingUsersData = async () => {
        try {
            const response = await fetch("https://hrbackend-2.onrender.com/getUserDataToADDtoTeam", {
                method: "GET"
            });
    ...
    return (
        <div>
            ...
            <Form onSubmit={handleSubmit} style={{ backgroundColor: "aliceblue", padding: "30px", borderRadius: "20px", margin: "15px" }}>
                <Image src={`https://hrbackend-2.onrender.com/${userValue.profile}`} style={{ width: "100px", borderRadius: "100px" }} alt="Profile" />
